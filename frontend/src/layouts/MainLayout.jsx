          ...
          <nav className="flex items-center space-x-4">
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/login"
                  className="text-sm font-medium text-gray-300 hover:text-white transition-colors px-3 py-2 hover:drop-shadow-[0_0_4px_rgba(255,255,255,0.4)]"
                >
                  Sign in
                </Link>
                ...
                <Link
                  to="/register"
                  className="text-sm font-medium bg-accent-burnt hover:bg-accent-dark text-white px-4 py-2 rounded-md transition-all glow-amber hover:scale-105 active:scale-95"
                >
                  Get Started
                </Link>
